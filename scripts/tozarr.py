...
# 1. 路徑設定
# ============================================================
H5_DIR = "/home/NAS/homes/brick-10015/Nimrod_2d_data/NIMROD_Train_datasets_sti/val"
ZARR_ROOT_DIR = "/home/NAS/homes/brick-10015/P2I-GAN-benchmark/datasets/nimrod"
ZARR_PATH = os.path.join(ZARR_ROOT_DIR, "nimrod_test.zarr")
...
root.attrs.update({
    "dataset_name": "Nimrod_2D_val",
    "description": "Nimrod rain field data for storm events",
    "num_events": 20,
    ...
    "source": "Nimrod radar data provided by the UK Met Office",
})
...
for evt in tqdm(EVENT_TABLE, desc="Converting events"):
    eid = evt["id"]
    h5_path = os.path.join(H5_DIR, f"{eid}.h5")
